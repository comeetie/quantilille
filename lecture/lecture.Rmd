...
Il reste a découper cette longue ligne en tronçons de 500m. Pour se faire nous allons commencé par créer un ensemble de points distants de 500m le long de la ligne et uniformiser l’échantillonnage de la ligne :
```{r}
