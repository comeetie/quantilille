...
En R, le package `banR` permet d'interroger l'API de la BAN. Ce package, non présent sur le CRAN, doit être installé via github. Il permet ensuite de géocoder une colonne d'adresses en batch en spécifiant la colonne contenant les adresses voire éventuellement une colonne contenant un code Insee pour faciliter et préciser la requête.
...
# Faire des cartes interactives avec R  
