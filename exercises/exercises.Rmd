...
Importez la couche des accidents de la route appelée 'accidents_75.geojson' et affichez la carte des accidents dans Paris en utilisant simplement la fonction `plot`. 
```
...
2. Faire une zone tampon autour de celui-ci de 1km
3. Extraire les centroïdes des iris
4. Calculez les distances entre les centroïdes des iis
5. Calculez les polygones de Voronoïs autour des centroïdes des iris
