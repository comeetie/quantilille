...
```{r, solution = TRUE}
library(sf)
iris.75 <- st_read("../data/iris_paris.shp", quiet = TRUE,
                   stringsAsFactors = F)
```
...
```{r, echo=FALSE}
sel_metro <-  c('Saint-Lazare','École Militaire',
                'Saint-Germain-des-Prés','Rennes',
                'Denfert-Rochereau','Colonel Fabien',
                'Saint-Placide','Oberkampf',"Place d'Italie",
                'La Tour Maubourg','Les Halles',
                'Filles du Calvaire','Mairie des Lilas',
                'Porte de la Villette',"Porte d'Italie",
                'Montparnasse-Bienvenüe','Balard','Château Rouge',
                "Gare d'Austerlitz","Gare de l'Est",
                'Palais Royal - Musée du Louvre',
                'Boulogne - Pont de Saint-Cloud','Richard Lenoir',
                'Strasbourg - Saint-Denis','Gare de Lyon',
                'Poissonnière','Tolbiac','Gare du Nord (Métro)')
